...
/*Comment:
 The original code has the problem: locka is set in the thread initializing a, and lockb is set in the thread initializing b. Then, lockb cannot be set in the first thread since it's not unset in the second thread, and vice versa.
